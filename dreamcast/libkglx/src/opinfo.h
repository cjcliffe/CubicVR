// Color ist funktionsname glopColor
// 4 ist Anzahl der benutzen Parameter in GLParam p[4+1]

ADD_OP(Color,4,"%f %f %f %f")
ADD_OP(TexCoord,2,"%f %f")
//ADD_OP(EdgeFlag,1,"%d")
...
// ADD_OP(PushMatrix,0,"")
// ADD_OP(PopMatrix,0,"")
ADD_OP(Rotatef,4,"%f %f %f %f")
ADD_OP(Translatef,3,"%f %f %f")
ADD_OP(Scalef,3,"%f %f %f")

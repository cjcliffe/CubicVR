...
#define	SET_COLOR_VALUE(red,green,blue,alpha)	\
	((alpha) << 24) | ((red) << 16) | ((green) << 8) | (blue);

#define	SET_COLOR(red,green,blue,alpha)	\
	vert_rgba = SET_COLOR_VALUE(red,green,blue,alpha)
...
extern GLboolean gl_depth_mask;
extern GLboolean gl_depth_mask_def;
extern GLenum gl_depth_func;
extern GLenum gl_depth_func_def;

extern GLint gl_blend_src_def;
extern GLint gl_blend_dst_def;
...
extern GLbitfield gl_first_list;

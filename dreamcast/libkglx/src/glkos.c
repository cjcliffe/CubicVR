...
// CVSID("$Id: glkos.c,v 1.13 2002/03/17 20:45:38 bardtx Exp $");
...
int glKosInit() {
    ...
    /* new */
    kos_exec_flag=GL_TRUE;
    kos_compile_flag=GL_FALSE;
    kos_print_flag=GL_FALSE;
...
void glKosBeginFrame() {
    ...
    pvr_scene_begin();
    gl_pbuf_submitted = GL_FALSE;
    gl_active_list = gl_first_list; //GL_LIST_FIRST;

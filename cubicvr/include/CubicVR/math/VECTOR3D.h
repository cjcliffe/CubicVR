...
public:
	...
	VECTOR3D(const XYZ &xyz_in)	:	x(xyz_in.x), y(xyz_in.y), z(xyz_in.z)
	{}
	...
	inline void operator=(const XYZ & xyz_in)
	{	x=xyz_in.x;	y=xyz_in.y;	z=xyz_in.z;	}
	...
	friend bool operator==(const VECTOR3D &vect1, const XYZ &vect2);
	friend bool operator!=(const VECTOR3D &vect1, const XYZ &vect2);
};	

inline bool operator==(const VECTOR3D &vect1, const XYZ &vect2)
{
